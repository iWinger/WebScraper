...
from scraper.alert import sendPricesEmail, sendQuotesEmail
...
def prices(id):
    ...
    htmlDoc = open('./templates/price.html', 'r+')
...
def alert():
    if(request.method == 'POST'):
        if (request.form['submit'] == 'Submit'):
            quoteEmail = request.form['alertQuote']
            itemEmail = request.form['alertItem']
            if(quoteEmail != ""):
                sendQuotesEmail(quoteEmail)
            if(itemEmail != ""):
                sendPricesEmail(itemEmail)
